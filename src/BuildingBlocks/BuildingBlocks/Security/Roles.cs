...
public static class KeycloakRoles
{
    ...
    public const string SupportLeagueRole = "support-league";
    ...
    public const string SupportTeamRole = "support-team";
    ...
    public const string SupportPlayerRole = "support-player";
    ...
    public const string SupportSeasonRole = "support-season";
    ...
    public const string SupportStandingsRole = "support-standings";
    ...
    public const string SupportGameRole = "support-game";
    ...
    public const string SupportStatRole = "support-stat";
}
...
public static class KeycloakPolicy
{
    ...
    public const string SupportLeaguePolicy = "SupportLeague";
    ...
    public const string SupportTeamPolicy = "SupportTeam";
    ...
    public const string SupportPlayerPolicy = "SupportPlayer";
    ...
    public const string SupportSeasonPolicy = "SupportSeason";
    ...
    public const string SupportStandingsPolicy = "SupportStandings";
    ...
    public const string SupportGamePolicy = "SupportGame";
    ...
    public const string SupportStatPolicy = "SupportStat";
}
