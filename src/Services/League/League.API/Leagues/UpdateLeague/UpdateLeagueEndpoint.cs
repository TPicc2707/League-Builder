...
public record UpdateLeagueRequest(Guid Id, string Name, string Sport, string Description, string OwnerFirstName, string OwnerLastName, string EmailAddress, string ImageFile);
