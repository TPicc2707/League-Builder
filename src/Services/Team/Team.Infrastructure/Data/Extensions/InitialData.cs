...
internal class InitialData
{
    ...
    public static IEnumerable<Domain.Models.Team> Teams
    {
        get
        {
            ...
            var manager1 = Manager.Of("tony", "piccirilli", "tony-piccirilli@team.com");
            var manager2 = Manager.Of("john", "doe", "john-doe@team.com");
            var manager3 = Manager.Of("timmy", "johnson", "timmy-johnson@team.com");
            var manager4 = Manager.Of("lisa", "monroe", "lisa-monroe@team.com");
            var manager5 = Manager.Of("larry", "sanders", "larry-sanders@team.com");
