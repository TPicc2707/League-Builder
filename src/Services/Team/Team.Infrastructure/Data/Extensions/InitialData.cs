...
internal class InitialData
{
    ...
    new List<League>
    {
        League.Create(LeagueId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")), "Dummy Baseball League", Sport.Of("Baseball"), "This league is made experienced players."),
        League.Create(LeagueId.Of(new Guid("05d80a72-d2dd-43c1-8ca0-ef1c0585db3b")), "Dummy Football League", Sport.Of("Football"), "This league is made experienced players.")
    };
    ...
    public static IEnumerable<Domain.Models.Team> Teams
    {
        get
        {
            ...
            return new List<Domain.Models.Team> { team1, team2, team3, team4 };
        }
    }
}
