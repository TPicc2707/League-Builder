...
public record CreateFootballStatsCommand(FootballStatsDto FootballStats)
    : ICommand<CreateFootballStatsResult>;

public record CreateFootballStatsResult(Guid Id);

public class CreateFootballStatsCommandValidator : AbstractValidator<CreateFootballStatsCommand>
{
    public CreateFootballStatsCommandValidator()
    {
