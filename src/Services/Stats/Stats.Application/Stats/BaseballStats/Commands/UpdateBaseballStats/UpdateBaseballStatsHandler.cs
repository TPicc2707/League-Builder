    ...
    : ICommandHandler<UpdateBaseballStatsCommand, UpdateBaseballStatsResult>
{
    ...
    private void UpdateBaseballStatsWithNewValues(Domain.Models.BaseballStats baseballStats, BaseballStatsDto baseballStatsDto)
    {
        var updatedHittingStats = BaseballHittingStats.Of(baseballStatsDto.HittingStats.AtBats, baseballStatsDto.HittingStats.Hits, baseballStatsDto.HittingStats.TotalBases, baseballStatsDto.HittingStats.Runs,
                                                   ...
                                                   baseballStatsDto.HittingStats.StolenBases, baseballStatsDto.HittingStats.CaughtStealing, baseballStatsDto.HittingStats.Strikeouts, baseballStatsDto.HittingStats.Walks, baseballStatsDto.HittingStats.HitByPitch, baseballStatsDto.HittingStats.SacrificeFly);
        var updatedPitchingStats = BaseballPitchingStats.Of(baseballStatsDto.PitchingStats.Wins, baseballStatsDto.PitchingStats.Losses, baseballStatsDto.PitchingStats.Runs, baseballStatsDto.PitchingStats.Start, baseballStatsDto.PitchingStats.Saves,
