...
namespace Stats.Infrastructure.Migrations
{
    ...
    [Migration("20260609153436_Add-Caught-Stealing")]
            ...
            modelBuilder.Entity("Stats.Domain.Models.BaseballStats", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "HittingStats", "Stats.Domain.Models.BaseballStats.HittingStats#BaseballHittingStats", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.Property<int>("CaughtStealing")
                                .HasColumnType("int");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "PitchingStats", "Stats.Domain.Models.BaseballStats.PitchingStats#BaseballPitchingStats", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Stats.Domain.Models.BasketballStats", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Stats", "Stats.Domain.Models.BasketballStats.Stats#BasketballPlayerStats", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Stats.Domain.Models.FootballStats", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "DefensiveStats", "Stats.Domain.Models.FootballStats.DefensiveStats#FootballDefensiveStats", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "KickingStats", "Stats.Domain.Models.FootballStats.KickingStats#FootballKickingStats", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "OffensiveStats", "Stats.Domain.Models.FootballStats.OffensiveStats#FootballOffensiveStats", b1 =>
                        {
                            b1.IsRequired();
