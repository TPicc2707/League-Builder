    ...
    : ICommandHandler<CreateGameCommand, CreateGameResult>
{
    ...
    {
        var gameDetail = GameDetail.Of(gameDto.GameDetail.AwayTeamScore, gameDto.GameDetail.HomeTeamScore, gameDto.GameDetail.StartTime, gameDto.GameDetail.EndTime, null, null, null, null, null, string.Empty);
